    ...
    for (i = 0; i < students.length; i++) {
        if (searched.value.toLowerCase() == students[i].name.toLowerCase()) {
            ...
            Swal.fire({
                ...
                text: ` Maths: ${students[i].math} | English: ${students[i].eng} | Hindi: ${students[i].urd} | Science ${students[i].sci}} | Total: ${students[i].math + students[i].eng + students[i].urd + students[i].sci} | Percentage: ${((students[i].math + students[i].eng + students[i].urd + students[i].sci) * 100 / 400).toFixed(2)}%`,
                icon: 'success',
